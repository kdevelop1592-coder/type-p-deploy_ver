...
const Content = (() => {
    ...
    const defaults = {
        ...
        keyboard_basic_ko: {
            items: [
                'ㅁ ㄴ ㅇ ㄹ', 'ㅓ ㅏ ㅣ ;', 'ㅁ ㄴ ㅇ ㄹ   ㅓ ㅏ ㅣ ;',
                'ㅁ ㅓ ㄴ ㅏ ㅇ ㅣ ㄹ ㅣ', 'ㄹ ㅏ ㅇ ㅣ ㄴ ㅓ ㅁ ㅓ', 'ㅇ ㅏ ㄴ ㅣ ㅇ ㅓ ㄹ ㅣ',
                'ㅂ ㅈ ㄷ ㄱ ㅅ', 'ㅛ ㅕ ㅑ ㅐ ㅔ', 'ㅂ ㅈ ㄷ ㄱ ㅅ   ㅛ ㅕ ㅑ ㅐ ㅔ',
                'ㄱ ㅏ ㅅ ㅓ ㄱ ㅗ ㅛ ㅕ', 'ㅂ ㅐ ㄷ ㅔ ㅅ ㅣ ㄱ ㅏ', 'ㅅ ㅜ ㅅ ㅏ ㄱㅗ ㄱㅣ',
                'ㅋ ㅌ ㅊ ㅍ ㅎ', 'ㅠ ㅜ ㅡ', 'ㅋ ㅌ ㅊ ㅍ ㅎ   ㅠ ㅜ ㅡ',
                'ㅊ ㅠ ㅍ ㅜ ㅋ ㅡ ㅎ ㅣ', 'ㅌ ㅓ ㅍ ㅜ ㅋ ㅏ ㅊ ㅣ', 'ㅍ ㅜ ㄹ ㅡ ㄴ ㅎ ㅏ ㄴ ㅡ ㄹ',
                'ㅃ ㅉ ㄸ ㄲ ㅆ', 'ㅒ ㅖ', 'ㅃ ㅉ ㄸ ㄲ ㅆ   ㅒ ㅖ',
                'ㄲ ㅒ ㄸ ㅖ ㅃ ㅏ ㅉ ㅓ', 'ㅆ ㅣ ㄲ ㅣ ㄸ ㅏ ㅃ ㅒ', 'ㄸ ㅓ ㄴ ㅏ ㄱㅣ',
                'ㅁ ㅂ ㅋ ㅃ   ㄴ ㅈ ㅌ ㅉ   ㅇ ㄷ ㅊ ㄸ   ㄹ ㄱ ㅍ ㄲ',
                'ㅏ ㅑ ㅓ ㅕ ㅗ ㅛ ㅜ ㅠ ㅡ ㅣ',
                'ㄱ ㅏ ㄴ ㅏ ㄷ ㅏ ㄹ ㅏ ㅁ ㅏ ㅂ ㅏ ㅅ ㅏ',
                'ㅇ ㅏ ㅈ ㅏ ㅊ ㅏ ㅋ ㅏ ㅌ ㅏ ㅍ ㅏ ㅎ ㅏ'
            ]
        },
